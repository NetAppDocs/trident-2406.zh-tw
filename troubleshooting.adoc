...
用於 Astra Trident 20.07 和 20.10 ，用於 `tprov`代替 `torc`。
...
WARNING: 此動作無法復原。除非您想要全新安裝 Astra Trident 、否則請勿這麼做。若要在不移除客戶需求日的情況下解除安裝 Astra Trident link:trident-managing-k8s/uninstall-trident.html["解除安裝Astra Trident"]、請參閱。
